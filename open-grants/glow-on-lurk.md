...
for the duration of the project, at the cost of $10000 per week.

- Study of how Lurk and zk-SNARK works, how to compile to circuits,
  ...
  that explains what needs to be done in more details.
  (3 weeks).

- Making a first attempt to add passes to the *Glow* compiler to generate Lurk code.
...
- Making a first attempt to simulate a blockchain using Lurk.
  The deliverable will be some Scheme, Common Lisp and/or Rust code
  that allow to effectively run code as generated by our first compiler attempt above.
...
- Analyzing the limitations of the first attempt and designing
...
- Refactoring the *Glow* compiler and runtime to enable the features
...
- Making a second attempt to add passes to the *Glow* compiler to generate Lurk code,
...
- Making a second attempt to simulate a blockchain using Lurk.
  The deliverable will be Scheme code that fully implements
...
- Packaging and documentation for the above.
...
The above plan totals 27 weeks of work, a bit over six months, at a cost of $270000.
...
We intend to introduce some compiler passes that target Filecoin's Lurk as part of our architecture,
and thereby gain support for targetting zk-SNARKs.
